...
namespace Assignment1a
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            playerOne = new PlayerObject(Content.Load<Texture2D>("Sprites\\player\\girlakin_standing"), 
                                         Content.Load<Texture2D>("Sprites\\player\\girlakin_running"), Vector2.Zero, scale, Color.White, 1f, 0f, true);
